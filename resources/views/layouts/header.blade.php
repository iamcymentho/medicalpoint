...
<head>
    ...
    <!-- Page Title -->
    <title>MedicalPoint || Leading the way in medical excellence</title>

    {{-- fonts --}}

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Gelasio:wght@500&family=Lobster+Two:ital@1&family=Satisfy&display=swap" rel="stylesheet">
    ...
    <header class="header-area">
        ...
        <div id="header" id="home">
            <div class="container">
                ...
                <div id="logo">
                    <a href="index.html"><img src="{{ asset('assets/images/logo/newlogo.png') }}" alt="" title="" /></a>
                </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="https://colorlib.com" target="_blank"></a>MedicalPoint
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
</span>
                    </div>
