...
@section('content')
<div class="container ">
    <div class="row justify-content-center registration mycontainer shadow">
        <div class="col-md-8 my-auto">
            <div class="card shadow">
                <div class="card-header text-center bg-dark text-white">{{ __('Register for an account ') }}</div>
