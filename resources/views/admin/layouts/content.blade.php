    ...
    <div class="widget">
        <div class="widget-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="state">
                    <h6 class="fancyfont">Patients</h6>
            ...
            <small class="text-small mt-10 d-block"><b>6% higher than last month</b></small>
        </div>
...
<div class="col-lg-3 col-md-6 col-sm-12">
    <div class="widget">
        <div class="widget-body">
            ...
            <small class="text-small mt-10 d-block"><b>61% higher than last month</b></small>
        </div>
        <div class="progress progress-sm">
...
<div class="col-lg-3 col-md-6 col-sm-12">
    <div class="widget">
        <div class="widget-body">
            ...
            <small class="text-small mt-10 d-block"><b>Total roles</b></small>
        </div>
        <div class="progress progress-sm">
...
<div class="col-lg-3 col-md-6 col-sm-12">
    <div class="widget">
        <div class="widget-body">
            ...
            <small class="text-small mt-10 d-block"><b>Total Bookings</b></small>
        </div>
        <div class="progress progress-sm">
...
<div class="col-lg-3 col-md-6 col-sm-12">
    <div class="widget">
        <div class="widget-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="state">
                    <h6 class="fancyfont">Prescription</h6>
            ...
            <small class="text-small mt-10 d-block"><b>Total Prescription</b></small>
        </div>
        <div class="progress progress-sm">
