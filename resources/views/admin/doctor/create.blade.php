            ...
            <div class="caed-body">
                <form action="{{ route('doctor.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mx-auto">
                        <div class="col-md-5 mt-3 mb-3 m-4">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter doctor's name" value="{{ old('name') }}">
                        ...
                        <div class="col-md-5 mt-3 mb-3 m-4 ">
                            ...
                            <input type="email" name="email"  class="form-control @error('email') is-invalid @enderror"  placeholder="Enter doctor's email" value="{{ old('email') }}">
                     ...
                     <div class="row mx-auto">
                        ...
                        <div class="col-md-5 mt-3 mb-3 m-4 ">
                            ...
                            <input type="text" name="address"  class="form-control @error('address') is-invalid @enderror" placeholder="Doctor's full address" value="{{ old('address') }}">
                ...
                <div class="col-md-5 mt-3 mb-3 m-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="phone_number"  class="form-control @error('phone_number') is-invalid @enderror" placeholder="Enter phone number" value="{{ old('phone_number') }}">
