               ...
               <div class="container">
                ...
                <form action="{{ route('patient') }}" method="GET">
                    @csrf
                     ...
                     <div class=" card-header fancyfont1">
                     Filter &nbsp;   <b>:</b> &nbsp; &nbsp; 
                    <div class="row mt-2">
                       
                    <div class="col-md-9">
                       <input type="text" class="form-control datetimepicker-input fancyfont1" id="datepicker" data-toggle="datetimepicker" data-target="#datepicker" name="date">
                    </div>
